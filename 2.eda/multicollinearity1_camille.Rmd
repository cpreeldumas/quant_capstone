...
```{r}
vif_data <- bls_data_did_nodc %>% 
  filter(date == "2020-10-01")

n_distinct(vif_data$idname)

#The multicollinearity test start from here!
model=lm(unemployment_rate ~ treatment + renters_occupied_percentage +
                   black_or_african_american_percentage + 
                   hispanic_or_latino_percentage +
                   bachelors_percentage +
                   median_age + 
...
```{r}
variables <- vif_data[, c("unemployment_rate", "treatment", "renters_occupied_percentage", 
...
variables_new <- vif_data[, c("treatment", "unemployment_rate", "renters_occupied_percentage",
                     "bachelors_percentage",
                     "black_or_african_american_percentage", 
                     "hispanic_or_latino_percentage",
                     "laborforce_16over")]
