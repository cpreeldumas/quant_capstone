...
#import data
bls_data <- read_csv("/Users/cpreeldumas/Documents/GitHub/quant_capstone/data_clean/data_v4.csv") %>% 
  clean_names("snake") %>% #convert column names to snake case
  rename(state_fips = state_fips_x,
         county_fips = county_fips_x,
         state = state_x) 
...
```{r}
attgt_nocovar <- att_gt(yname = "unemployment_rate_s",
                   gname = "first_treat",
                   idname = "idname",
                   tname = "new_year_mo",
                   clustervars = "idname",
