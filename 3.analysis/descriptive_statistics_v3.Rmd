...
```{r}
data_ds <- read_csv("~/Documents/Coding Projects/quant_capstone/data_clean/data_v4.csv") %>%
  clean_names("snake") %>%
...
data_ds_2 <- cbind(data_pre, data_post)
...
gt(data_ds_2, rownames_to_stub = TRUE) |>
cols_align(
  align = c("center"),
  columns = 2:5
  ) |>
