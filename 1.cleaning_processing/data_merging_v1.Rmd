...
```{r}
covariates_census <- read_csv("~/Documents/Coding Projects/quant_capstone/data_raw/covariates_census_v1.csv") %>%
...
write.csv(data3, "Documents/Coding Projects/quant_capstone/data_clean/data_v1.csv", row.names=FALSE)
