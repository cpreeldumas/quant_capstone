...
```{r}
covariates_census <- read_csv("~/Documents/Coding Projects/quant_capstone/data_raw/covariates_census_v5.csv") %>%
...
```{r}
BLS_data <- read_csv("~/Documents/Coding Projects/quant_capstone/data_clean/BLS_county_employment_clean.csv") %>%
...
data <- left_join(BLS_data, covariates_covid_statespend, by = c("date", "county_fips", "state_fips", "state"))
...
write.csv(data3, "~/Documents/Coding Projects/quant_capstone/data_clean/data_v2.csv", row.names=FALSE)
