#--------------------------------------
#
#  Code adapted from https://github.com/jagman88/Clean-BLS-County-Level-Employment-Data 
#
#--------------------------------------
...
#              'la.data.0.CurrentU10-14','la.data.0.CurrentU15-19','la.data.0.CurrentU20-24']
...
#    output.close()
#
# Note: BLS responds with error if above code is used. The files were instead downloaded manually via browser as .txt files.
#------------------------------------------------------

# Import area information
df_areas = pd.read_table('/Users/denise/Coding/Capstone_2023/Capstone Data/Raw/la.area.txt')
...
#df_areas['state'] = df_areas['state'].map(lambda x: x.strip())    # Doesn't work?
...
def get_BLS_county_data(BLS_data_path, df_areas):
    ...
    # Remove white space from column names # Update
    df_bls_county.rename(columns=lambda x: x.strip(), inplace=True)

    #Convert column type
    df_bls_county['series_id'] = df_bls_county['series_id'].astype(str)
    df_bls_county['year'] = df_bls_county['year'].astype(int)
    df_bls_county['period'] = df_bls_county['period'].astype(str)
    df_bls_county['value'] = df_bls_county['value'].astype(str)
    df_bls_county['footnote_codes'] = df_bls_county['footnote_codes'].astype(str)
...
df_unemp_90_94 = get_BLS_county_data('/Users/denise/Coding/Capstone_2023/Capstone Data/Raw/la.data.0.CurrentU90-94.txt', df_areas)
df_unemp_95_99 = get_BLS_county_data('/Users/denise/Coding/Capstone_2023/Capstone Data/Raw/la.data.0.CurrentU95-99.txt', df_areas)
df_unemp_00_04 = get_BLS_county_data('/Users/denise/Coding/Capstone_2023/Capstone Data/Raw/la.data.0.CurrentU00-04.txt', df_areas)
df_unemp_05_09 = get_BLS_county_data('/Users/denise/Coding/Capstone_2023/Capstone Data/Raw/la.data.0.CurrentU05-09.txt', df_areas)
df_unemp_10_14 = get_BLS_county_data('/Users/denise/Coding/Capstone_2023/Capstone Data/Raw/la.data.0.CurrentU10-14.txt', df_areas)
df_unemp_15_19 = get_BLS_county_data('/Users/denise/Coding/Capstone_2023/Capstone Data/Raw/la.data.0.CurrentU15-19.txt', df_areas)
df_unemp_20_24 = get_BLS_county_data('/Users/denise/Coding/Capstone_2023/Capstone Data/Raw/la.data.0.CurrentU20-24.txt', df_areas)

#------------------------------------------------------------
# Merge all year's data  # Updated
df_unemp_county = df_unemp_90_94
df_unemp_county = pd.concat([df_unemp_county, df_unemp_95_99])
df_unemp_county = pd.concat([df_unemp_county, df_unemp_00_04])
df_unemp_county = pd.concat([df_unemp_county, df_unemp_05_09])
df_unemp_county = pd.concat([df_unemp_county, df_unemp_10_14])
df_unemp_county = pd.concat([df_unemp_county, df_unemp_15_19])
df_unemp_county = pd.concat([df_unemp_county, df_unemp_20_24])
